...
class NotificationService:
    ...
    def __init__(self, config=None):
        ...
        if self.config.alert_method:
            logger.info(f"NotificationService initialized with method: {self.config.alert_method}")
        else:
            logger.info("NotificationService initialized with no alert method configured")
