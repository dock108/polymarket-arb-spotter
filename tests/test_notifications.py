...
from app.core.notifications import NotificationService, send_alert, get_notification_service
...
class TestNotificationService(unittest.TestCase):
    ...
    def test_send_telegram_success(self, mock_post):
        ...
        self.assertIn('sendMessage', call_args[1]['url'] if 'url' in call_args[1] else call_args[0][0])
    ...
    def test_send_email_success(self, mock_smtp):
        ...
        mock_server.login.assert_called_once_with(
            self.config_email.email_username,
            self.config_email.email_password
        )
